...
def test_credit_application_migration(tmp_path):
 ...
 assert ScriptDirectory.from_config(Config('alembic.ini')).get_heads()==['20260731_0016'];downgrade(d,'20260728_0011');assert 'credit_note_applications' not in inspect(create_engine(f'sqlite:///{d}')).get_table_names();upgrade(d,'20260728_0012')
